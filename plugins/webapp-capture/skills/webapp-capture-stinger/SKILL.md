...
This skill is self-contained. When the matching skills from The Hive (Legion Code Inc.) are also installed, hand off to them:
...
- [webapp-capture-worker-bee](../../agents/webapp-capture-worker-bee.md) - The paired agent in this plugin; delegate script-heavy capture stages to it.
